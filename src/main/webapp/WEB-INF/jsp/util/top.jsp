...
<body style="font-family: 'Nanum Gothic', sans-serif; min-height: 100%">
    ...
    <div class="row">
        <div class="col-10">
            <nav class="header-navigation stricky original">
                <div class="container clearfix" style=" margin-right: 10%;">
                    <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="main-nav__main-navigation">
                        <ul class=" main-nav__navigation-box">
                            <li class="dropdown">
                                <a href="/bsa/silages"><button class="dropdown-btn"><i class="fa fa-angle-right"></i></button>
                                </a>
                            </li><li class="dropdown" style="margin-left: 0px;">
                            <a href="/bsa/silages"> 메인
                                <button class="dropdown-btn"><i class="fa fa-angle-right"></i></button>
                            </a>
                        </li>
                            <li class="dropdown" style=" margin-left: 0px;">
                                <a href="" onclick="needLogin()"> 등록 내역
                                    <button class="dropdown-btn"><i class="fa fa-angle-right"></i></button>
                                </a>
                            </li>
                            <li class="dropdown" style=" margin-left: 0px;">
                                <a href="" onclick="needLogin()"> 구매 내역
                                    <button class="dropdown-btn"><i class="fa fa-angle-right"></i></button>
                                </a>
                            </li>
                        </ul>
        ...
        <div class="col-2" >
            <div class="topbar-one__left" style="margin-top: 6%">
...
<div class="side-menu__block">
    ...
    <div class="side-menu__block-inner  mCustomScrollbar _mCS_1 mCS_no_scrollbar">
        <div id="mCSB_2" class="mCustomScrollBox mCS-dark mCSB_vertical mCSB_inside" style="max-height: none;"
             tabindex="0">
